...
Now that individual images can be processed the pipeline gets applied to a series of images from a video stream.
Here's a [link to the resulting video](./output.mp4)
